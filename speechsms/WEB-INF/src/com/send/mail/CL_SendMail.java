...
public class CL_SendMail {
	...
	public static boolean sendPersonalizedMail(String recipient, String subject,String message,String qrcode,String filename)  
	{
	 ...
	 public static final boolean sendPersonalizedMail1(String emailid,final String fromemailid,final String password,String subject,String message,String hostname,String portnumber)  
		{
