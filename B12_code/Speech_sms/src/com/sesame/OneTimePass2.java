...
public class OneTimePass2 extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.onetimepass2);
				...
				else
				{
					 ...
					 BufferedReader in = null;
						...
						// Execute HTTP Post Request
						 try
						 {
							response = CustomHttpClient.executeHttpPost(Global.URL+"speechsms/checkotp2.jsp", nameValuePairs);
							...
							else if(response.trim().equalsIgnoreCase(c1.trim()))
							{
								...
								Intent i = new Intent(getApplicationContext(), OneTimePass2.class);
								startActivity(i);
							}
